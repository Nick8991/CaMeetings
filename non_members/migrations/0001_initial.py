...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='Loan_Balance',
            fields=[
                ('loan', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, serialize=False, to='non_members.outsider_loan')),
        ...
        migrations.CreateModel(
            name='Unpaid',
            fields=[
                ('outsider_repayment', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, serialize=False, to='non_members.outsider_repayment')),
                ('balance', models.PositiveBigIntegerField(blank=True)),
                ('loan_interest', models.PositiveBigIntegerField()),
                ('outsider_loan', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='non_members.outsider_loan')),
            ],
        ),
    ]
